...
/* harmony import */ var _public_shared_Partials_Nav__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_public_shared_Partials_Nav__WEBPACK_IMPORTED_MODULE_1__);
...
function create_fragment(ctx) {
  ...
  var nav;
  var current;
  nav = new (_public_shared_Partials_Nav__WEBPACK_IMPORTED_MODULE_1___default())({
    $$inline: true
  });
  var block = {
    c: function create() {
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$capture_state = function () {
    return {
      Nav: (_public_shared_Partials_Nav__WEBPACK_IMPORTED_MODULE_1___default()),
