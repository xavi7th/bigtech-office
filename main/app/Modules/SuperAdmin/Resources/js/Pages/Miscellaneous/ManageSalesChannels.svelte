...
<Layout title="Manage Sales Channel">
    <div class="row vertical-gap">
        <div class="col-lg-4 col-xl-4">

            <form class="#" class:was-validated={createSalesChannel}>
                <FlashMessage />
                ...
                <div class="row vertical-gap sm-gap">
                    <div class="col-12">
                        <label for="amount">Enter New Sales Channel</label>
                        <input
                            type="text"
        ...
        <div class="col-lg-8 col-xl-8">
            <div
                ...
                <h2 class="mnb-2" id="formBase">Available Sales Channel</h2>
            </div>
