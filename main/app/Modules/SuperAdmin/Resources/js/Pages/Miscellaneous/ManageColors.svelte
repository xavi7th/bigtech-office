...
<Layout title="Manage Colors">
    <div class="row vertical-gap">
        <div class="col-lg-4 col-xl-4">

            <form class="#" class:was-validated={createColor}>
                <FlashMessage />
                ...
                <div class="row vertical-gap sm-gap">
                    <div class="col-12">
                        <label for="amount">Enter New Color</label>
                        <input
                            type="text"
        ...
        <div class="col-lg-8 col-xl-8">
            <div
                ...
                <h2 class="mnb-2" id="formBase">Available Colors</h2>
            </div>
