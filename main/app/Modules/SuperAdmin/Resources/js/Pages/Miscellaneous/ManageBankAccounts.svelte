...
<Layout title="Manage Company Bank Accounts">
  <div class="row vertical-gap">
    <div class="col-lg-4 col-xl-4">

      <form class="#" class:was-validated={createBankAccount}>
        <FlashMessage />
        ...
        <div class="row vertical-gap sm-gap">
          <div class="col-12">
            <label for="amount">Enter New Company Bank Accounts</label>
            <input
              type="text"
    ...
    <div class="col-lg-8 col-xl-8">
      <div class="d-flex align-items-center justify-content-between mb-25">
        <h2 class="mnb-2" id="formBase">Available Company Bank Accounts</h2>
      </div>
