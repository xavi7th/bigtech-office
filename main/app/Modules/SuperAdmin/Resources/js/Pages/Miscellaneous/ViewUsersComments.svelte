    ...
    <form class="rui-messenger rui-messenger-full no-emoji">
          ...
          <div class="rui-messenger-collapse">
            ...
            {#each Object.entries(userComments) as [user, details], idx (idx)}
              <div
                ...
                <a href="#home" class="media-link rui-messenger-item">
                  ...
                  <span class="media-body">
                    <span class="media-title">{details.meta.full_name}</span>
                    <small class="media-subtitle">{user}</small>
            ...
            {:else}
              <div class="media media-success media-filled">
                <a href="#home" class="media-link rui-messenger-item">
                  ...
                  <span class="media-body">
                    <span class="media-title">NO USER COMMENTS</span>
                  </span>
                </a>
              </div>
            {/each}
      ...
      <div class="rui-messenger-chat">
        ...
        <div class="rui-messenger-head">
          <a
            href="#"
            class="btn btn-clean btn-uniform btn-grey-4 rui-messenger-back
            d-flex d-lg-none">
            <span
          ...
          <button type="button" class="btn btn-custom-round d-flex d-lg-none">
            <span
              data-feather="more-vertical"
              class="rui-icon rui-icon-stroke-1_5" />
          </button>
        ...
        <div class="rui-messenger-body rui-scrollbar">
          <div>
            ...
            {#each Object.entries(activeComments) as [humanTime, comments]}
              <small class="rui-messenger-message-datetime">{humanTime}</small>
              {#each comments as comment}
                <div
                  class="rui-messenger-message rui-messenger-message-incoming">
                  <ul>
                    <li>
