            ...
            <div class="tab-content">
                <div
                    ...
                    <div class="row vertical-gap">
                        <div class="col-lg-5">
                            <p class="lead">
                                Check the boxes on the table to confirm device
                                test
                            </p>
                            <p class="lead text-danger">
                                If a device test is completed, this table should
                                be replaced with the table on the right showing
                                successful completed test data....if e make
                                brain let me know Mr. Dan
                            </p>
