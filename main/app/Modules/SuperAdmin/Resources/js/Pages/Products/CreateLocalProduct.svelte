...
<Layout title="Create Local Supplier Stock">
    ...
    <div class="col-lg-8 col-xl-6">
      <form class="#">
        <div class="row vertical-gap sm-gap">
          ...
          <div class="col-6">
            <label for="exampleBase1">RAM Size</label>
            <div class="input-group">
              <select class="custom-select">
                <option selected>Select</option>
                <option value="1">One</option>
          ...
          <div class="col-6">
            <label for="exampleBase1">Storage Type</label>
            <div class="input-group">
              <select class="custom-select">
                <option selected>Select</option>
                <option value="1">One</option>
          ...
          <div class="col-6">
            <label for="exampleBase1">Processor Speed</label>
            <div class="input-group">
              <select class="custom-select">
                <option selected>Select</option>
                <option value="1">One</option>
          ...
          <div class="col-6">
            <label for="localProductCost">Cost Price</label>
            <input
              type="text"
              class="form-control"
              id="localProductCost"
          ...
          <div class="col-6">
            <label for="localProductSellingPrice">Proposed Selling Price</label>
            <input
              type="text"
              class="form-control"
              id="localProductSellingPrice"
