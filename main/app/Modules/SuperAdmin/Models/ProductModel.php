...
class ProductModel extends BaseModel
{
  ...
  public static function multiAccessRoutes()
  {
    Route::group(['prefix' => 'product-models'], function () {
      ...
      Route::put('{productModel}/edit', [self::class, 'editProductModel'])->name($gen('models', '.edit_product_model'))->middleware('auth:super_admin,auditor,web_admin');
      ...
      Route::put('{productModel}/qa-tests', [self::class, 'updateProductModelQATests'])->name($gen('models', '.update_model_qa_tests'))->middleware('auth:super_admin,auditor,web_admin');
      ...
      Route::post('{productModel}/images/create', [self::class, 'createProductModelImage'])->name($gen('models', '.create_model_image'))->middleware('auth:auditor,web_admin');
      Route::delete('images/{id}/delete', [self::class, 'deleteProductModelImage'])->name($gen('models', '.delete_model_image'))->middleware('auth:super_admin,auditor,web_admin');
      Route::post('{productModel}/comment', [self::class, 'commentOnProductModel'])->name($gen('models', '.comment_on_model'))->middleware('auth:super_admin,auditor,web_admin');
    });
  }
