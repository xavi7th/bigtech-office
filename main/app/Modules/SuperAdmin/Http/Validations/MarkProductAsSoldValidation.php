...
class MarkProductAsSoldValidation extends FormRequest
{
  ...
  public function rules()
  {
    return [
      ...
      'id_card' => 'required_if:is_swap_transaction,true|image|mimes:jpeg,png,jpg,gif,svg',
      'receipt' => 'required_if:is_swap_transaction,true|image|mimes:jpeg,png,jpg,gif,svg',
