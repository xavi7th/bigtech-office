        ...
        <div class="nav-panel__row">
          ...
          <div class="nav-panel__nav-links nav-links">
            <ul class="nav-links__list">
              ...
              {#each topMenuRoutes as item, imdex}
                <li
                  :key="index"
                  class="nav-links__item"
                  class:nav-links__item--has-submenu={!item.name}
                  v-if="!item.meta.desktopMenuSkip">
                  <router-link
                    :to="item.path"
                    v-if="item.name"
                    class="nav-links__item-link">
                    <div class="nav-links__item-body">{item.meta.menuName}</div>
                  </router-link>
                  <a href="#" v-else class="nav-links__item-link">
                    <div class="nav-links__item-body">
                      ...
                      <svg
                        ...
                        height="6px">
                        <use
                          xlink:href="/img/sprite.svg#arrow-rounded-down-9x6" />
                      </svg>
                    </div>
                  </a>
                  <div
                    ...
                    <div class="menu menu--layout--classic">
                      ...
                      <ul class="menu__list">
                        <template v-for="childItem in item.children">
                          <li
                            :key="childItem.name"
                            v-if="!childItem.meta.desktopMenuSkip"
                            class="menu__item">
                            <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                            <div class="menu__item-submenu-offset" />
                            <router-link
                                ...
                                <ul class="menu__list">
                                  <template
                                    ...
                                    <li
                                      ...
                                      v-if="!grandChildItem.meta.desktopMenuSkip">
                                      <!-- This is a synthetic element that allows to adjust the vertical offset of the submenu using CSS. -->
                                      <div class="menu__item-submenu-offset" />
                                      <router-link
          ...
          <div class="nav-panel__nav-links nav-links">
            <ul class="nav-links__list">
              ...
              <li class="nav-links__item nav-links__item--has-submenu">
                ...
                <div
                  class="nav-links__submenu nav-links__submenu--type--megamenu
          ...
          <div class="nav-panel__indicators">
              ...
              <a href="wishlist.html" class="indicator__button">
                <span class="indicator__area">
                  <svg width="20px" height="20px">
                    <use xlink:href="images/sprite.svg#heart-20" />
                  </svg>
                  ...
                  <div class="dropcart__body">
                    <div class="dropcart__products-list">
                      <div class="dropcart__product">
                        ...
                        <button
                          type="button"
                          class="dropcart__product-remove btn btn-light btn-sm
                          btn-svg-icon">
            ...
            <div class="indicator indicator--trigger--click">
              <a href="account-login.html" class="indicator__button">
                <span class="indicator__area">
                  <svg width="20px" height="20px">
                    <use xlink:href="images/sprite.svg#person-20" />
                  </svg>
                </span>
              </a>
              <div class="indicator__dropdown">
