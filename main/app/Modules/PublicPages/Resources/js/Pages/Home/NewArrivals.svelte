        ...
        <div class="block-header__arrows-list">
          <button class="block-header__arrow block-header__arrow--left" type="button">
            <svg width="7px" height="11px">
              <use xlink:href="/img/sprite.svg#arrow-rounded-left-7x11" />
            </svg>
          </button>
          <button class="block-header__arrow block-header__arrow--right" type="button">
            <svg width="7px" height="11px">
              <use xlink:href="/img/sprite.svg#arrow-rounded-right-7x11" />
            </svg>
          </button>
        </div>
      </div>
              ...
              <div class="product-card">
                <button class="product-card__quickview" type="button">
                  <svg width="16px" height="16px">
                    <use xlink:href="/img/sprite.svg#quickview-16" />
                  </svg>
                ...
                <div class="product-card__actions">
                  ...
                  <div class="product-card__buttons">
                    ...
                    >
                      <svg width="16px" height="16px">
                        <use xlink:href="/img/sprite.svg#wishlist-16" />
                      </svg>
                    ...
                    >
                      <svg width="16px" height="16px">
                        <use xlink:href="/img/sprite.svg#compare-16" />
                      </svg>
