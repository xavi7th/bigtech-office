  ...
  public function transformForSuperAdminViewSalesReps(SalesRep $salesRep)
  {
    return [
      ...
      'statistics' => [
        ...
        'monthly_online_sales_amount' => (float)$salesRep->monthlyl_online_sales_amount,
        ...
        'last_month_online_sales_count' => (float)$salesRep->last_month_online_sales_records_count,
        'last_month_walk_in_sales_count' => (float)$salesRep->last_month_walk_in_sales_records_count,
        'last_month_online_sales_amount' => (float)$salesRep->last_monthl_online_sales_amount,
        'last_month_walk_in_sales_amount' => (float)$salesRep->last_month_walk_in_sales_amount,
        'last_month_online_sales_bonus_amount' => (float)$salesRep->last_month_online_sales_bonus_amount,
        'last_month_walk_in_sales_bonus_amount' => (float)$salesRep->last_month_walk_in_sales_bonus_amount,
