...
<body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0"
	onload="saveDiv(divId = 'invoice', filename = 'My {{ $receipt->product->product_model->name }} Receipt - {{ $receipt->created_at->toDateString() }} ')">
																									...
																									<div class="box-body no-padding">
																										<table class="table table-sm table-hover">
																											...
																											<tbody>
																												<tr>
																													<td>1.</td>
																													<td>{{ $receipt->product->swapped_deal_device->description }}
																													</td>
																													<td>
																								...
																								<div class="table-responsive">
																									<table class="table">
																										...
																										<tr>
																											...
																											<td>
																												{{ to_naira($receipt->tax_rate / 100 * $receipt->amount_paid) }}
																											</td>
																										</tr>
																										<tr>
																											<th>Shipping:</th>
																									...
																									<div class="col-12 p-0">
																										<ol>
																											<li>New devices procured from The Elects Online store fall under
																												...
																												forwarded to Manufacturer’s Warranty Centres for new devices.
																											</li>
																											<li>Please ensure that you retain the original packaging of the
																												cell phone as well as the customer pickup document (receipt) as
																												you will be required to produce these for warranty and/or
																												exchange purposes.</li>
																											<li>Prior to utilizing your cell phone and/or the battery, it is
																												advisable to first charge the battery for a given time period
																												stipulated by the manufacturer. This will assist the durability
																												of the battery life.</li>
																											<li>Warranty provided by the manufacturer does not cover
																												non-manufacturer and/or physical damage and/or liquid damage
																												(dead device) caused by negligent use of the cellphone.</li>
																											<li>If caught trading in a stolen device, you agree to be handed
																												over to the appropriate authorities.</li>
																											<li>In the event that your cellphone has a manufacturer’s fault
																												and it is identified at the place and time of purchase, the
																												cellphone can be returned for replacement.</li>
																											<li>Unless otherwise stipulated by the manufacturer, your
																												cellphone has a warranty cover of one (1) year and battery
																											...
																											<li>In the event that your used device while under our warranty
																												develops fault covered under our warranty, the cellphone can be
